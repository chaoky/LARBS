...
# LARBS by Luke Smith <luke@lukesmith.xyz> License: GNU GPLv3
# Lordie's Version
...
while getopts ":a:b:c:h" o; do case "${o}" in
	h) echo -e "\\n  -a: Stanbot-i11 \\n  -b: Stanbot-xps13\\n  -c: aaaa \\n  -h: Show this message" && exit ;;
	a) dotfilesrepo="https://github.com/lukesmithxyz/voidrice.git"
           progsfile="https://raw.githubusercontent.com/chaoky/LARBS/master/progs.csv"
           && exit;;
	b) dotfilesrepo="https://github.com/lukesmithxyz/voidrice.git"
           progsfile="https://raw.githubusercontent.com/chaoky/LARBS/master/progs.csv"
           && exit;;
	c) dotfilesrepo="https://github.com/lukesmithxyz/voidrice.git"
           progsfile="https://raw.githubusercontent.com/chaoky/LARBS/master/progs.csv"
           && exit;;
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "This script will automatically install the chosen configuration." 10 60
	}
